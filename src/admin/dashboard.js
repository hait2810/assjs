        ...
        <div class="content w-[1600px] bg-[#80b435]">
          <div class="dashboard w-[1170px] mx-auto py-[10px] ">
              <ul class="flex justify-center" >
                ...
                <li class="pr-[20px]"><a class="uppercase text-white hover:border-b-2 border-solid" href="/#/admin/showcate">Danh mục</a></li>
                <li class="pr-[20px]"><a class="uppercase text-white hover:border-b-2 border-solid" href="/#/admin/addcate">Thêm danh mục mục</a></li>
              </ul>
          </div>
      </div>
        `;
